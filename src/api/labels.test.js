...
describe('saveName', () => {
  ...
  it('should save all labels to localStorage (3)', () => {
    const name = 'awesome.vitalik.arb'
    const nameArray = ['awesome', 'vitalik', 'arb']
    const hashes = [
...
describe('parseName', () => {
  ...
  it('should parse all the labels (3) and return the encoded string', () => {
    const name = `0x${blahblahHash}.vitalik.arb`
    const encodedName = `[${blahblahHash}].vitalik.arb`
    const parsedName = parseName(name)
